...
import 'package:just_audio_demo/subtitle_box.dart';
...
class MyAppState extends State<MyApp> with WidgetsBindingObserver {
  ...
  Future<void> _init() async {
    ...
    try {
      ...
      await _player.setAudioSource(AudioSource.uri(Uri.parse(
          "https://firebasestorage.googleapis.com/v0/b/medappoint-1b031.appspot.com/o/audio%2Faankhein-ro-ro-ke-sujane-wale.mp3?alt=media&token=0fdd4a30-bf8b-4ffb-9f6e-8af9e12201e3")));
    } catch (e) {
    ...
    List<Subtitle> subtiles = controller.subtitles;
    debugPrint(subtiles[0].data);
  }
